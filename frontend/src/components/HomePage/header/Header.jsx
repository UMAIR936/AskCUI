  ...
  return (
    <nav class="navbar navbar-expand-lg bg-light">
      <div class="container-fluid">
        <a>
          <img src={mylogo} alt="" style={{ width: "150px" }} />
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <Link class="nav-link mx-3" to="/ourhome">
                BLOGS
              </Link>
            </li>
            <li class="nav-item">
              <Link class="nav-link mx-3" to="/ask">
                ASK
              </Link>
            </li>
            <li class="nav-item">
              <Link class="nav-link mx-3" to="/docs">
                DOCUMENTS
              </Link>
            </li>
            <li class="nav-item">
              <Link class="nav-link mx-3" to="/hostel">
                HOSTELS
              </Link>
            </li>
            <li class="nav-item">
              <Link class="nav-link mx-3" to="/food">
                FOOD
              </Link>
            </li>
            <li class="nav-item">
            ...
            <li>
              {user ? (
                ...
                >
                  ...
                  <div>
                    {/* <p style={{ marginLeft: "18px" }}>{users.fname}</p> */}
                  </div>
                  <NavDropdown.Divider />
